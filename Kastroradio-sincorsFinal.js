    ...
    d.kastroradio = function(m, w) {
        ...
        */
        ...
        function wb(b) {
            ...
            "" == Da && (d("#" + c + "coverwrapper, #" + c + "coverwrapper1, #" + c + "coverwrapper2").css({
                "border-radius": "10%"
        ...
        function Bb(b) {
            ...
            "" == Da && d("#" + c + "smallcoverwrapper, #" + c + "smallcoverwrapper1, #" + c + "smallcoverwrapper2").css({
                "border-radius": "10%"
            })
        }
        ...
        for (var hb = t(w.token, ""), ja = t(w.userinterface, "small").toString().toLowerCase(), kb = t(w.backgroundcolor, "rgba(0,0,0,0)"), x = t(w.fontcolor, "#ffffff"), q = t(w.hightlightcolor, "#f86808"), aa = t(w.fontname, ""), ib = t(w.googlefont, ""), cb = t(w.fontratio, "0.4"), Ya = t(w.radioname, ""), zb = t(w.scroll, "true").toString().toLowerCase(), ma = t(w.coverimage, "data:image/png;base64,"),
                za = t(w.onlycoverimage, "false").toString().toLowerCase(), Da = t(w.coverstyle, "").toString().toLowerCase(), V = t(w.usevisualizer, "fake").toString().toLowerCase(), qa = parseInt(t(w.visualizertype, 4)), Xa = t(w.itunestoken, ""), fa = t(w.metadatatechnic, "php").toString().toLowerCase(), qb = t(w.ownmetadataurl, ""), ua = t(w.corsproxy, ""), lb = t(w.usestreamcorsproxy, "false").toString().toLowerCase(), Z = t(w.streamurl, ""), Va = t(w.streamtype, "other").toString().toLowerCase(), Ca = t(w.icecastmountpoint, ""), sb = t(w.radionomyid,
