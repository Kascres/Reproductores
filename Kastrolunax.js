/*!
 * kastro RADIO PLAYER V5.20.08.31
 * https://www.kastro-universe.com
 *
...
! function(e, t) {
    ...
    e.fn.kastroradio = function(i) {
        ...
        return i = !a && o.length ? e.extend.apply(null, [!0, i].concat(o)) : i, a && "_" === i.charAt(0) ? n : (a ? this.each(function() {
            var a = e(this).data("kastroradio"),
                r = a && e.isFunction(a[i]) ? a[i].apply(a, o) : a;
            if (r !== a && r !== t) return n = r, !1
        }) : this.each(function() {
            e(this).data("kastroradio", new e.kastroradio(this, i))
        }), n)
    }, e.kastroradio = function(i, a) {
        var o = i.id;
        if (arguments.length) {
        ...
        function je(t) {
            ...
            de = e("#" + r).width(), le = e("#" + r).height(), "small" == T && 0 == le && (Ne = !0, He()), Ue("Roboto:400"), "" != B && Ue(B), o = "@keyframes " + r + "pulse { ", o = (o = (o = (o = (o = (o = (o = (o = (o = (o += "\t0% { ") + "\t  fill: rgba(" + gt(M).r + ", " + gt(M).g + ", " + gt(M).b + ", 1.0);") + "\t} ") + "\t50% { ") + "\t  fill: rgba(" + gt(I).r + ", " + gt(I).g + ", " + gt(I).b + ", 1.0); ") + "\t} ") + "\t100% { ") + "\t\tfill: rgba(" + gt(M).r + ", " + gt(M).g + ", " + gt(M).b + ", 1.0); ") + "\t} ") + "}", e("head").append('<style type="text/css">' + o + "</style>"),  (! function() {
                ...
                t.innerHTML = "", e("#" + r).addClass("kastroaudioplayer").css({
                    overflow: "hidden",
                    display: "block"
                });
                ...
                (m = new Audio).id = r + "html5audio", m.preload = "auto", "true" == ne && (ft("autoplay enabled"), m.autoplay = !0), m.addEventListener("timeupdate", function() {
                    ...
                    a.id = r + "playerwrapper", t.appendChild(a), e("#" + r + "playerwrapper").css({
                        ...
                        function(t) {
                            ...
                            o.id = r + "coverwrapper", t.appendChild(o), e("#" + r + "coverwrapper").css({
                                ...
                                "" != Se && window.open(Se)
                            }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "coverwrapper1", o.appendChild(a), e("#" + r + "coverwrapper1").css({
                                position: "absolute",
                                left: "0px",
                                top: "0px",
                                height: "100%",
                        ...
                        }).html(y).kastroradiodisableSelection(), "false" == re && e("#" + r + "iconlive").css({
                            display: "none"
                        });
                    (i = document.createElement("div")).id = r + "buttonvolumeoff", a.appendChild(i), e("#" + r + "buttonvolumeoff").css({
                        ...
                        ct(0)
                    }).kastroradiodisableSelection(), (i = document.createElement("div")).id = r + "buttonvolumeon", a.appendChild(i), e("#" + r + "buttonvolumeon").css({
                        position: "absolute",
                        transition: "fill 0.5s",
                        cursor: "pointer",
                        fill: M
                        ...
                        ct(100)
                    }).kastroradiodisableSelection(), (i = document.createElement("div")).id = r + "buttonanalyzer", a.appendChild(i), e("#" + r + "buttonanalyzer").css({
                        position: "absolute",
                        transition: "fill 0.5s",
                        cursor: "pointer",
                        fill: M
                    ...
                    }).kastroradiodisableSelection(), "false" == se && e("#" + r + "buttonanalyzer").css({
                        display: "none"
                    });
                    (i = document.createElement("span")).classList.add(r + "textradionamespan"), a.appendChild(i), e("." + r + "textradionamespan").css({
                            ...
                            "font-family": z,
                            color: M
                        }).addClass(r + "textradioname").html(e("." + r + "textradionamespan")).kastroradiodisableSelection(), (i = document.createElement("span")).classList.add(r + "texttitlespan"), a.appendChild(i), e("." + r + "texttitlespan").css({
                            "padding-left": "10px",
                            "padding-right": "10px",
                            margin: "0",
                            "white-space": "nowrap",
                            ...
                            "font-family": z,
                            color: M
                        }).addClass(r + "texttitle").html(e("." + r + "texttitlespan")).kastroradiodisableSelection(), (i = document.createElement("div")).id = r + "textvolumeend", a.appendChild(i), e("#" + r + "textvolumeend").css({
                            position: "absolute",
                            "text-align": "center",
                            "font-family": "Roboto",
                            color: M
                        ...
                        function(t) {
                            ...
                            a.id = r + "volumebackground", i.appendChild(a), e("#" + r + "volumebackground").css({
                                ...
                                width: "100%",
                                background: M
                            }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "volumefill", i.appendChild(a), e("#" + r + "volumefill").css({
                                position: "absolute",
                                width: "0",
                                background: I
                            }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "volumeicon", i.appendChild(a), e("#" + r + "volumeicon").css({
                                position: "absolute",
                                top: "0px",
                                "border-radius": "50%",
                                background: I
                            }).kastroradiodisableSelection(), (a = document.createElement("img")).id = r + "volumegrab", i.appendChild(a), a.src = k, e("#" + r + "volumegrab").css({
                                position: "absolute",
                                top: "0px",
                                left: "0px",
                                cursor: "pointer",
                        ...
                        function(t) {
                            ...
                            a.id = r + "buttonplay", i.appendChild(a), e("#" + r + "buttonplay").css({
                                ...
                                e(this).css("fill", M)
                            }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "buttonpause", i.appendChild(a), e("#" + r + "buttonpause").css({
                                position: "absolute",
                                top: "0px",
                                left: "0px",
                                width: "100%",
                                ...
                                e(this).css("fill", M)
                            }).fadeOut(0).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "audiopreloader", i.appendChild(a), e("#" + r + "audiopreloader").css({
                                position: "absolute",
                                top: "0px",
                                left: "0px",
                                width: "100%",
                                height: "100%",
                                fill: M
                            }).html(v).fadeOut(0).kastroradiodisableSelection()
                    ...
                    }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "smalliconlive", i.appendChild(a), e("#" + r + "smalliconlive").css({
                        position: "absolute",
                        fill: "rgba(" + gt(M).r + ", " + gt(M).g + ", " + gt(M).b + ", 0.3)"
                    }).html(y).kastroradiodisableSelection(), "false" == re && e("#" + r + "smalliconlive").css({
                        display: "none"
                    });
                    (a = document.createElement("div")).id = r + "smalltextvolume", i.appendChild(a), e("#" + r + "smalltextvolume").css({
                        ...
                        }).html("100").kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "smalliconvolume", i.appendChild(a), e("#" + r + "smalliconvolume").css({
                            position: "absolute",
                            fill: "rgba(" + gt(M).r + ", " + gt(M).g + ", " + gt(M).b + ", 0.3)"
                        }).html(x).kastroradiodisableSelection(), (a = document.createElement("span")).classList.add(r + "smalltextradionamespan"), i.appendChild(a), e("." + r + "smalltextradionamespan").css({
                            "padding-right": "30px",
                            margin: "0",
                            "white-space": "nowrap",
                            "font-family": z,
                            ...
                            "font-family": z,
                            color: M
                        }).addClass(r + "smalltextradioname").html(e("." + r + "smalltextradionamespan")).kastroradiodisableSelection(), (a = document.createElement("span")).classList.add(r + "smalltexttitlespan"), i.appendChild(a), e("." + r + "smalltexttitlespan").css({
                            "padding-right": "30px",
                            margin: "0",
                            "white-space": "nowrap",
                            "font-family": z,
                            ...
                            "font-family": z,
                            color: M
                        }).addClass(r + "smalltexttitle").html(e("." + r + "smalltexttitlespan")).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "smallvolumegrab", i.appendChild(a), e("#" + r + "smallvolumegrab").css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
                            cursor: "pointer",
                        ...
                        function(t) {
                            ...
                            a.id = r + "smallbuttonplay", i.appendChild(a), e("#" + r + "smallbuttonplay").css({
                                ...
                                e(this).css("fill", M)
                            }).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "smallbuttonpause", i.appendChild(a), e("#" + r + "smallbuttonpause").css({
                                position: "absolute",
                                top: "0px",
                                left: "0px",
                                width: "100%",
                                ...
                                e(this).css("fill", M)
                            }).fadeOut(0).kastroradiodisableSelection(), (a = document.createElement("div")).id = r + "smallaudiopreloader", i.appendChild(a), e("#" + r + "smallaudiopreloader").css({
                                position: "absolute",
                                top: "0px",
                                left: "0px",
                                width: "100%",
        ...
        function Ze(t) {
            if ("true" == L) {
                var i = "";
                "small" == T && (i = "small"), t && e("#" + r + i + "texttitle").hasClass(r + "Marquee") && (e("#" + r + i + "texttitle").removeClass(r + "Marquee"), e("#" + r + i + "texttitle").html(e("." + r + i + "texttitlespan").first()), e("#" + r + i + "texttitle").data("kastroradioMarquee").pause()), e("#" + r + i + "textradioname").width() > e("." + r + i + "textradionamespan").first().width() ? e("#" + r + i + "textradioname").hasClass(r + "Marquee") && (e("#" + r + i + "textradioname").removeClass(r + "Marquee"), e("#" + r + i + "textradioname").html(e("." + r + i + "textradionamespan").first()), e("#" + r + i + "textradioname").data("kastroradioMarquee").pause()) : e("#" + r + i + "textradioname").hasClass(r + "Marquee") || (e("#" + r + i + "textradioname").addClass(r + "Marquee"), e("#" + r + i + "textradioname").html(e("." + r + i + "textradionamespan").first()), e("#" + r + i + "textradioname").kastroradioMarquee()), e("#" + r + i + "texttitle").width() > e("." + r + i + "texttitlespan").first().width() ? e("#" + r + i + "texttitle").hasClass(r + "Marquee") && (e("#" + r + i + "texttitle").removeClass(r + "Marquee"), e("#" + r + i + "texttitle").html(e("." + r + i + "texttitlespan").first()), e("#" + r + i + "texttitle").data("kastroradioMarquee").pause()) : e("#" + r + i + "texttitle").hasClass(r + "Marquee") || (e("#" + r + i + "texttitle").addClass(r + "Marquee"), e("#" + r + i + "texttitle").html(e("." + r + i + "texttitlespan").first()), e("#" + r + i + "texttitle").kastroradioMarquee())
            }
        }
        ...
        e(document).ready(function() {
            if (ft("SCRIPT FOLDER: " + (Re = function(e) {
                    ...
                    return n
                }("kastroradio.min.js"))), ft("USERAGENT: " + navigator.userAgent), ft("BROWSER: " + ke.browser.name), ft("OS: " + ke.os.name), ft("usevisualizer: " + O), ft("visualizertype: " + D), ft("ismobile: " + ("mobile" == ke.device.type)), "true" == ne) {
                ne = "false";
                try {
                    var e = new Audio;
        ...
        function tt() {
            ft("playmode");
            try {
                e(".kastroaudioplayer").each(function() {
                    e(this).attr("id") != r && e(this).data("kastroradio").pause()
                })
            } catch (e) {
                ft(e)
            }
...
function(e, t) {
    ...
    m.VERSION = "0.7.21", m.BROWSER = {
        ...
        NAME: a,
        VERSION: r
    }, "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = m), exports.kastroradioParser = m) : "function" == typeof define && define.amd ? define(function() {
        return m
    }) : e && (e.kastroradioParser = m);
...
function(e, t) {
    ...
    "use strict";
    e.fn.kastroradioMarquee = function(i) {
        var a = "kastroradioMarquee",
            o = "string" == typeof i,
        ...
        return i = !o && n.length ? e.extend.apply(null, [!0, i].concat(n)) : i, o && "_" === i.charAt(0) ? r : (o ? this.each(function() {
            ...
            e(this).data(a, new e.kastroradioMarquee(this, i))
        }), r)
    }, e.kastroradioMarquee = function(e, t) {
        var i, a, o = 0,
            n = 0,
...
function(e) {
    ...
    d._binds = [], e.fn.kastroradiograb = function(e, a) {
    ...
    }, e.fn.kastroradioungrab = function(e) {
        return this.each(function() {
            l(this, i, i)
        })
    }
